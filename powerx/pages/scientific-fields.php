...
$scientificFieldsQuery = $obj->show_scientific_fields();

$scientific_field_id = null;
if (isset($_GET['scientific_field_id'])) {
    $scientific_field_id = $_GET['scientific_field_id'];
}
$projectReasearchersQuery = null;
if ($scientific_field_id != null) {
    $projectReasearchersQuery = $obj->show_active_project_researchers_per_scientific_field($scientific_field_id);
}
?>
                                ...
                                <div class="dataTable_wrapper">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            while ($result = $scientificFieldsQuery->fetch_object()) { ?>
                                                <tr class="odd gradeX">
                                                    <td><?php echo htmlentities($result->id); ?></td>
                                                    <td><?php echo htmlentities($result->name); ?></td>
                                                    <td>&nbsp;&nbsp;
                                                        <a href="scientific-fields.php?scientific_field_id=<?php echo htmlentities($result->id); ?>">
                                                        <button>View</button>
                                                        </a>
                                                    </td>
                                                    </td>
                ...
                if ($scientific_field_id != null) { ?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    View Projects/Researchers of Scientific Field
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="dataTable_wrapper">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                if ($projectReasearchersQuery != null) {
                                                    while ($result = $projectReasearchersQuery->fetch_object()) { ?>
                                                        <tr class="odd gradeX">
